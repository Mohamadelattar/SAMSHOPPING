      ...
      addBtn.forEach(function(btn) {
         btn.addEventListener("click",function(event){
            ...
            if(event.target.classList.contains("bag-btn"))
            {
               ...
               cartItem.innerHTML= '<img src="'+item.img+'" alt="test"> <div> <h4>'+item.name+'</h4><h5>'+item.finalPrice+'</h5><span class="remove-item">Supprimer</span></div></div><div><i class="fas fa-chevron-up"></i><p class="item-amount">1</p><i class="fas fa-chevron-down"></i></div>';
